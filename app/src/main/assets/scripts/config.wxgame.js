        ...
        if (command == 'build') {
            ...
            return {
                ...
                commands: [
                    ...
                    new built_in_1.ManifestPlugin({ output: 'manifest.js', useWxPlugin: useWxPlugin })
                ]
            };
        }
        else {
