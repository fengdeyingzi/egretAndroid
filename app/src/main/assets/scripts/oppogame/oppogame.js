...
var OppogamePlugin = (function () {
    function OppogamePlugin() {
    }
    OppogamePlugin.prototype.onFile = function (file) {
    ...
    OppogamePlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    return OppogamePlugin;
}());
exports.OppogamePlugin = OppogamePlugin;
