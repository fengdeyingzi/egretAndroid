...
var MygamePlugin = (function () {
    function MygamePlugin() {
    }
    MygamePlugin.prototype.onFile = function (file) {
    ...
    MygamePlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.MygamePlugin = MygamePlugin;
