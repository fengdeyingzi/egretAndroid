...
var BaidugamePlugin = (function () {
    function BaidugamePlugin() {
    }
    BaidugamePlugin.prototype.onFile = function (file) {
    ...
    BaidugamePlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var gameJSONPath = path.join(pluginContext.outputDir, "game.json");
    ...
    return BaidugamePlugin;
}());
exports.BaidugamePlugin = BaidugamePlugin;
